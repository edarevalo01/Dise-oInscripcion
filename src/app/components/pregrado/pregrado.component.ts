...
export class PregradoComponent implements OnInit {
  ...
  constructor(
    ...
    this.registrarInscripcionForm = this.formBuilder.group({
      primerNombre: ["", [Validators.required, Validators.pattern("^[a-zA-Z0-9]*$")]],
      segundoNombre: ["", Validators.pattern("^[a-zA-Z0-9]*$")],
      primerApellido: ["", [Validators.required, Validators.pattern("^[a-zA-Z0-9]*$")]],
      segundoApellido: ["", Validators.pattern("^[a-zA-Z0-9]*$")],
